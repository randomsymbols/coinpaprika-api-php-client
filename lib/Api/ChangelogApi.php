...
class ChangelogApi
{
    ...
    /**
     * Operation getChangelogIDs
     *
     * Get id changelog for all coins
     *
     * @param  float $page Results page number. The number of records in the response is 100 (optional, default to 1)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getChangelogIDs'] to see the possible values for this operation
     *
     ...
     * @return array[]|\Randomsymbols\Coinpaprika\Model\TooManyRequestsError
     */
    public function getChangelogIDs($page = 1, string $contentType = self::contentTypes['getChangelogIDs'][0])
    {
        list($response) = $this->getChangelogIDsWithHttpInfo($page, $contentType);
        return $response;
    }

    /**
     * Operation getChangelogIDsWithHttpInfo
     *
     * Get id changelog for all coins
     *
     * @param  float $page Results page number. The number of records in the response is 100 (optional, default to 1)
     ...
     * @throws \Randomsymbols\Coinpaprika\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of array[]|\Randomsymbols\Coinpaprika\Model\TooManyRequestsError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getChangelogIDsWithHttpInfo($page = 1, string $contentType = self::contentTypes['getChangelogIDs'][0])
    {
        $request = $this->getChangelogIDsRequest($page, $contentType);
    ...
    /**
     * Operation getChangelogIDsAsync
     *
     * Get id changelog for all coins
     *
     * @param  float $page Results page number. The number of records in the response is 100 (optional, default to 1)
     ...
     */
    public function getChangelogIDsAsync($page = 1, string $contentType = self::contentTypes['getChangelogIDs'][0])
    {
        return $this->getChangelogIDsAsyncWithHttpInfo($page, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getChangelogIDsAsyncWithHttpInfo
     *
     * Get id changelog for all coins
     *
     * @param  float $page Results page number. The number of records in the response is 100 (optional, default to 1)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getChangelogIDsAsyncWithHttpInfo($page = 1, string $contentType = self::contentTypes['getChangelogIDs'][0])
    {
        $returnType = 'array[]';
        $request = $this->getChangelogIDsRequest($page, $contentType);
    ...
    /**
     * Create request for operation 'getChangelogIDs'
     *
     * @param  float $page Results page number. The number of records in the response is 100 (optional, default to 1)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getChangelogIDs'] to see the possible values for this operation
     *
     ...
     */
    public function getChangelogIDsRequest($page = 1, string $contentType = self::contentTypes['getChangelogIDs'][0])
    {



        $resourcePath = '/changelog/ids';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
