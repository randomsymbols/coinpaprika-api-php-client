...
class PeopleApi
{
     ...
     * @return \Randomsymbols\Coinpaprika\Model\PersonById|\Randomsymbols\Coinpaprika\Model\IdNotFoundError|\Randomsymbols\Coinpaprika\Model\TooManyRequestsError
     */
    public function getPeopleById($person_id, string $contentType = self::contentTypes['getPeopleById'][0])
    {
        list($response) = $this->getPeopleByIdWithHttpInfo($person_id, $contentType);
        return $response;
    }
     ...
     * @throws \Randomsymbols\Coinpaprika\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Randomsymbols\Coinpaprika\Model\PersonById|\Randomsymbols\Coinpaprika\Model\IdNotFoundError|\Randomsymbols\Coinpaprika\Model\TooManyRequestsError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPeopleByIdWithHttpInfo($person_id, string $contentType = self::contentTypes['getPeopleById'][0])
    {
        $request = $this->getPeopleByIdRequest($person_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Randomsymbols\Coinpaprika\Model\PersonById' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Randomsymbols\Coinpaprika\Model\PersonById' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Randomsymbols\Coinpaprika\Model\PersonById', []),
            ...
            $returnType = '\Randomsymbols\Coinpaprika\Model\PersonById';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Randomsymbols\Coinpaprika\Model\PersonById',
     ...
     */
    public function getPeopleByIdAsync($person_id, string $contentType = self::contentTypes['getPeopleById'][0])
    {
        return $this->getPeopleByIdAsyncWithHttpInfo($person_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPeopleByIdAsyncWithHttpInfo($person_id, string $contentType = self::contentTypes['getPeopleById'][0])
    {
        $returnType = '\Randomsymbols\Coinpaprika\Model\PersonById';
        $request = $this->getPeopleByIdRequest($person_id, $contentType);
     ...
     */
    public function getPeopleByIdRequest($person_id, string $contentType = self::contentTypes['getPeopleById'][0])
    {

        // verify the required parameter 'person_id' is set
        if ($person_id === null || (is_array($person_id) && count($person_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $person_id when calling getPeopleById'
            );
        }


        $resourcePath = '/people/{person_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
