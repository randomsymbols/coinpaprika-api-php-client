...
class GlobalApi
{
     ...
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['globalGet'] to see the possible values for this operation
     *
     ...
     * @return \Randomsymbols\Coinpaprika\Model\ModelGlobal|\Randomsymbols\Coinpaprika\Model\TooManyRequestsError
     */
    public function globalGet(string $contentType = self::contentTypes['globalGet'][0])
    {
        list($response) = $this->globalGetWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation globalGetWithHttpInfo
     *
     * Get market overview data
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['globalGet'] to see the possible values for this operation
     ...
     * @throws \Randomsymbols\Coinpaprika\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Randomsymbols\Coinpaprika\Model\ModelGlobal|\Randomsymbols\Coinpaprika\Model\TooManyRequestsError, HTTP status code, HTTP response headers (array of strings)
     */
    public function globalGetWithHttpInfo(string $contentType = self::contentTypes['globalGet'][0])
    {
        $request = $this->globalGetRequest($contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Randomsymbols\Coinpaprika\Model\ModelGlobal' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Randomsymbols\Coinpaprika\Model\ModelGlobal' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Randomsymbols\Coinpaprika\Model\ModelGlobal', []),
            ...
            $returnType = '\Randomsymbols\Coinpaprika\Model\ModelGlobal';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Randomsymbols\Coinpaprika\Model\ModelGlobal',
     ...
     */
    public function globalGetAsync(string $contentType = self::contentTypes['globalGet'][0])
    {
        return $this->globalGetAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation globalGetAsyncWithHttpInfo
     *
     * Get market overview data
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['globalGet'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function globalGetAsyncWithHttpInfo(string $contentType = self::contentTypes['globalGet'][0])
    {
        $returnType = '\Randomsymbols\Coinpaprika\Model\ModelGlobal';
        $request = $this->globalGetRequest($contentType);
    ...
    /**
     * Create request for operation 'globalGet'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['globalGet'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     ...
     */
    public function globalGetRequest(string $contentType = self::contentTypes['globalGet'][0])
    {
