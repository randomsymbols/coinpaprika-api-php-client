...
class KeyApi
{
    ...
    /**
     * Operation keyInfoGet
     *
     * Get API key info
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['keyInfoGet'] to see the possible values for this operation
     *
     ...
     * @return \Randomsymbols\Coinpaprika\Model\Info|\Randomsymbols\Coinpaprika\Model\TooManyRequestsError
     */
    public function keyInfoGet(string $contentType = self::contentTypes['keyInfoGet'][0])
    {
        list($response) = $this->keyInfoGetWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation keyInfoGetWithHttpInfo
     *
     * Get API key info
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['keyInfoGet'] to see the possible values for this operation
     ...
     * @throws \Randomsymbols\Coinpaprika\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Randomsymbols\Coinpaprika\Model\Info|\Randomsymbols\Coinpaprika\Model\TooManyRequestsError, HTTP status code, HTTP response headers (array of strings)
     */
    public function keyInfoGetWithHttpInfo(string $contentType = self::contentTypes['keyInfoGet'][0])
    {
        $request = $this->keyInfoGetRequest($contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Randomsymbols\Coinpaprika\Model\Info' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Randomsymbols\Coinpaprika\Model\Info' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Randomsymbols\Coinpaprika\Model\Info', []),
            ...
            $returnType = '\Randomsymbols\Coinpaprika\Model\Info';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Randomsymbols\Coinpaprika\Model\Info',
     ...
     */
    public function keyInfoGetAsync(string $contentType = self::contentTypes['keyInfoGet'][0])
    {
        return $this->keyInfoGetAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation keyInfoGetAsyncWithHttpInfo
     *
     * Get API key info
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['keyInfoGet'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function keyInfoGetAsyncWithHttpInfo(string $contentType = self::contentTypes['keyInfoGet'][0])
    {
        $returnType = '\Randomsymbols\Coinpaprika\Model\Info';
        $request = $this->keyInfoGetRequest($contentType);
    ...
    /**
     * Create request for operation 'keyInfoGet'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['keyInfoGet'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     ...
     */
    public function keyInfoGetRequest(string $contentType = self::contentTypes['keyInfoGet'][0])
    {


        $resourcePath = '/key/info';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
