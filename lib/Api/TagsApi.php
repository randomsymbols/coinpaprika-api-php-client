...
class TagsApi
{
     ...
     * List tags
     *
     * @param  string $additional_fields Comma separated list of additional fields to include in query result for each tag. Currently supported values are: \&quot;coins\&quot; and \&quot;icos\&quot;. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['tagsGet'] to see the possible values for this operation
     *
     ...
     * @return \Randomsymbols\Coinpaprika\Model\Tag[]|\Randomsymbols\Coinpaprika\Model\TooManyRequestsError
     */
    public function tagsGet($additional_fields = null, string $contentType = self::contentTypes['tagsGet'][0])
    {
        list($response) = $this->tagsGetWithHttpInfo($additional_fields, $contentType);
        return $response;
    }
     ...
     * @throws \Randomsymbols\Coinpaprika\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Randomsymbols\Coinpaprika\Model\Tag[]|\Randomsymbols\Coinpaprika\Model\TooManyRequestsError, HTTP status code, HTTP response headers (array of strings)
     */
    public function tagsGetWithHttpInfo($additional_fields = null, string $contentType = self::contentTypes['tagsGet'][0])
    {
        $request = $this->tagsGetRequest($additional_fields, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Randomsymbols\Coinpaprika\Model\Tag[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Randomsymbols\Coinpaprika\Model\Tag[]' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Randomsymbols\Coinpaprika\Model\Tag[]', []),
            ...
            $returnType = '\Randomsymbols\Coinpaprika\Model\Tag[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Randomsymbols\Coinpaprika\Model\Tag[]',
     ...
     */
    public function tagsGetAsync($additional_fields = null, string $contentType = self::contentTypes['tagsGet'][0])
    {
        return $this->tagsGetAsyncWithHttpInfo($additional_fields, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function tagsGetAsyncWithHttpInfo($additional_fields = null, string $contentType = self::contentTypes['tagsGet'][0])
    {
        $returnType = '\Randomsymbols\Coinpaprika\Model\Tag[]';
        $request = $this->tagsGetRequest($additional_fields, $contentType);
     ...
     */
    public function tagsGetRequest($additional_fields = null, string $contentType = self::contentTypes['tagsGet'][0])
    {
     ...
     * @param  string $additional_fields Comma separated list of additional fields to include in query result for each tag. Currently supported values are: \&quot;coins\&quot; and \&quot;icos\&quot;. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['tagsTagIdGet'] to see the possible values for this operation
     *
     * @throws \Randomsymbols\Coinpaprika\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Randomsymbols\Coinpaprika\Model\Tag|\Randomsymbols\Coinpaprika\Model\IdNotFoundError|\Randomsymbols\Coinpaprika\Model\TooManyRequestsError
     */
    public function tagsTagIdGet($tag_id, $additional_fields = null, string $contentType = self::contentTypes['tagsTagIdGet'][0])
    {
        list($response) = $this->tagsTagIdGetWithHttpInfo($tag_id, $additional_fields, $contentType);
        return $response;
    }
     ...
     * @throws \Randomsymbols\Coinpaprika\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Randomsymbols\Coinpaprika\Model\Tag|\Randomsymbols\Coinpaprika\Model\IdNotFoundError|\Randomsymbols\Coinpaprika\Model\TooManyRequestsError, HTTP status code, HTTP response headers (array of strings)
     */
    public function tagsTagIdGetWithHttpInfo($tag_id, $additional_fields = null, string $contentType = self::contentTypes['tagsTagIdGet'][0])
    {
        $request = $this->tagsTagIdGetRequest($tag_id, $additional_fields, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function tagsTagIdGetAsync($tag_id, $additional_fields = null, string $contentType = self::contentTypes['tagsTagIdGet'][0])
    {
        return $this->tagsTagIdGetAsyncWithHttpInfo($tag_id, $additional_fields, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function tagsTagIdGetAsyncWithHttpInfo($tag_id, $additional_fields = null, string $contentType = self::contentTypes['tagsTagIdGet'][0])
    {
        $returnType = '\Randomsymbols\Coinpaprika\Model\Tag';
        $request = $this->tagsTagIdGetRequest($tag_id, $additional_fields, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function tagsTagIdGetRequest($tag_id, $additional_fields = null, string $contentType = self::contentTypes['tagsTagIdGet'][0])
    {
