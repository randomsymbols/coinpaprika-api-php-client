...
class ToolsApi
{
    ...
    /**
     * Operation priceConverterGet
     *
     * Price converter
     *
     * @param  string $base_currency_id base_currency_id (required)
     * @param  string $quote_currency_id quote_currency_id (required)
     * @param  int $amount amount (optional, default to 0)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['priceConverterGet'] to see the possible values for this operation
     *
     ...
     * @return \Randomsymbols\Coinpaprika\Model\PriceConverterResponse|\Randomsymbols\Coinpaprika\Model\TooManyRequestsError
     */
    public function priceConverterGet($base_currency_id, $quote_currency_id, $amount = 0, string $contentType = self::contentTypes['priceConverterGet'][0])
    {
        list($response) = $this->priceConverterGetWithHttpInfo($base_currency_id, $quote_currency_id, $amount, $contentType);
        return $response;
    }

    /**
     * Operation priceConverterGetWithHttpInfo
     *
     * Price converter
     *
     * @param  string $base_currency_id (required)
     * @param  string $quote_currency_id (required)
     * @param  int $amount (optional, default to 0)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['priceConverterGet'] to see the possible values for this operation
     *
     * @throws \Randomsymbols\Coinpaprika\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Randomsymbols\Coinpaprika\Model\PriceConverterResponse|\Randomsymbols\Coinpaprika\Model\TooManyRequestsError, HTTP status code, HTTP response headers (array of strings)
     */
    public function priceConverterGetWithHttpInfo($base_currency_id, $quote_currency_id, $amount = 0, string $contentType = self::contentTypes['priceConverterGet'][0])
    {
        $request = $this->priceConverterGetRequest($base_currency_id, $quote_currency_id, $amount, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Randomsymbols\Coinpaprika\Model\PriceConverterResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Randomsymbols\Coinpaprika\Model\PriceConverterResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Randomsymbols\Coinpaprika\Model\PriceConverterResponse', []),
            ...
            $returnType = '\Randomsymbols\Coinpaprika\Model\PriceConverterResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Randomsymbols\Coinpaprika\Model\PriceConverterResponse',
    ...
    /**
     * Operation priceConverterGetAsync
     *
     * Price converter
     *
     * @param  string $base_currency_id (required)
     ...
     */
    public function priceConverterGetAsync($base_currency_id, $quote_currency_id, $amount = 0, string $contentType = self::contentTypes['priceConverterGet'][0])
    {
        return $this->priceConverterGetAsyncWithHttpInfo($base_currency_id, $quote_currency_id, $amount, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation priceConverterGetAsyncWithHttpInfo
     *
     * Price converter
     *
     * @param  string $base_currency_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function priceConverterGetAsyncWithHttpInfo($base_currency_id, $quote_currency_id, $amount = 0, string $contentType = self::contentTypes['priceConverterGet'][0])
    {
        $returnType = '\Randomsymbols\Coinpaprika\Model\PriceConverterResponse';
        $request = $this->priceConverterGetRequest($base_currency_id, $quote_currency_id, $amount, $contentType);
    ...
    /**
     * Create request for operation 'priceConverterGet'
     *
     * @param  string $base_currency_id (required)
     * @param  string $quote_currency_id (required)
     * @param  int $amount (optional, default to 0)
     ...
     */
    public function priceConverterGetRequest($base_currency_id, $quote_currency_id, $amount = 0, string $contentType = self::contentTypes['priceConverterGet'][0])
    {

        // verify the required parameter 'base_currency_id' is set
        if ($base_currency_id === null || (is_array($base_currency_id) && count($base_currency_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $base_currency_id when calling priceConverterGet'
            );
        }

        // verify the required parameter 'quote_currency_id' is set
        if ($quote_currency_id === null || (is_array($quote_currency_id) && count($quote_currency_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $quote_currency_id when calling priceConverterGet'
            );
        }



        $resourcePath = '/price-converter';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $base_currency_id,
            'base_currency_id', // param base name
            'string', // openApiType
            '', // style
            false, // explode
            true // required
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $quote_currency_id,
            'quote_currency_id', // param base name
            'string', // openApiType
            '', // style
            false, // explode
            true // required
     ...
     * Search
     *
     * @param  string $q phrase for search eg. &#x60;btc&#x60; (required)
     * @param  string $c one or more categories (comma separated) to search. Available options: &#x60;currencies|exchanges|icos|people|tags&#x60; (optional, default to 'currencies,exchanges,icos,people,tags')
     * @param  string $modifier set modifier for search results. Available options: &#x60;symbol_search&#x60; - search only by symbol (works for currencies only) (optional)
     * @param  int $limit limit of results per category (max 250) (optional, default to 6)
     ...
     * @throws \Randomsymbols\Coinpaprika\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Randomsymbols\Coinpaprika\Model\SearchResults|\Randomsymbols\Coinpaprika\Model\TooManyRequestsError
     */
    public function searchGet($q, $c = 'currencies,exchanges,icos,people,tags', $modifier = null, $limit = 6, string $contentType = self::contentTypes['searchGet'][0])
    {
        list($response) = $this->searchGetWithHttpInfo($q, $c, $modifier, $limit, $contentType);
        return $response;
    }
     ...
     * @throws \Randomsymbols\Coinpaprika\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Randomsymbols\Coinpaprika\Model\SearchResults|\Randomsymbols\Coinpaprika\Model\TooManyRequestsError, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchGetWithHttpInfo($q, $c = 'currencies,exchanges,icos,people,tags', $modifier = null, $limit = 6, string $contentType = self::contentTypes['searchGet'][0])
    {
        $request = $this->searchGetRequest($q, $c, $modifier, $limit, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Randomsymbols\Coinpaprika\Model\SearchResults' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Randomsymbols\Coinpaprika\Model\SearchResults' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Randomsymbols\Coinpaprika\Model\SearchResults', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 429:
            ...
            $returnType = '\Randomsymbols\Coinpaprika\Model\SearchResults';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Randomsymbols\Coinpaprika\Model\SearchResults',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchGetAsync($q, $c = 'currencies,exchanges,icos,people,tags', $modifier = null, $limit = 6, string $contentType = self::contentTypes['searchGet'][0])
    {
        return $this->searchGetAsyncWithHttpInfo($q, $c, $modifier, $limit, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchGetAsyncWithHttpInfo($q, $c = 'currencies,exchanges,icos,people,tags', $modifier = null, $limit = 6, string $contentType = self::contentTypes['searchGet'][0])
    {
        $returnType = '\Randomsymbols\Coinpaprika\Model\SearchResults';
        $request = $this->searchGetRequest($q, $c, $modifier, $limit, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function searchGetRequest($q, $c = 'currencies,exchanges,icos,people,tags', $modifier = null, $limit = 6, string $contentType = self::contentTypes['searchGet'][0])
    {
