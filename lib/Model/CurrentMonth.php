...
/**
 * CurrentMonth Class Doc Comment
 *
 * @category Class
 ...
 */
class CurrentMonth implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'current_month';
    ...
    protected static $setters = [
        'requests_made' => 'setRequestsMade',
        'requests_left' => 'setRequestsLeft'
    ];
    ...
    protected static $getters = [
        'requests_made' => 'getRequestsMade',
        'requests_left' => 'getRequestsLeft'
    ];
    ...
    {
        $this->setIfExists('requests_made', $data ?? [], null);
        $this->setIfExists('requests_left', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['requests_made'];
    }

    /**
     * Sets requests_made
     *
     * @param float|null $requests_made Number of requests made in the current month. If a plan has no limit on the number of requests, e.g., `Enterprise` plan, then the value of `requests_made` is -1
     *
     * @return self
     */
    public function setRequestsMade($requests_made)
    {
        if (is_null($requests_made)) {
            throw new \InvalidArgumentException('non-nullable requests_made cannot be null');
        }
        $this->container['requests_made'] = $requests_made;
    ...
    {
        return $this->container['requests_left'];
    }

    /**
     * Sets requests_left
     *
     * @param float|null $requests_left Number of requests left in the  current month. If a plan has no limit on the number of requests, e.g., `Enterprise` plan, then the value of `requests_left` is -1
     *
     * @return self
     */
    public function setRequestsLeft($requests_left)
    {
        if (is_null($requests_left)) {
            throw new \InvalidArgumentException('non-nullable requests_left cannot be null');
        }
        $this->container['requests_left'] = $requests_left;
