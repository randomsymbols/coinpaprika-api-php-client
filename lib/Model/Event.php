...
class Event implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $attributeMap = [
        ...
        'link' => 'link',
        'proof_image_link' => 'proof_image_link'
    ];
    ...
    protected static $setters = [
        ...
        'is_conference' => 'setIsConference',
        'link' => 'setLink',
        'proof_image_link' => 'setProofImageLink'
    ];
    ...
    protected static $getters = [
        ...
        'is_conference' => 'getIsConference',
        'link' => 'getLink',
        'proof_image_link' => 'getProofImageLink'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_conference', $data ?? [], null);
        $this->setIfExists('link', $data ?? [], null);
        $this->setIfExists('proof_image_link', $data ?? [], null);
    }
    ...
    */
     ...
     * @return bool|null
     */
    public function getIsConference()
    {
        return $this->container['is_conference'];
    }

    /**
     * Sets is_conference
     *
     * @param bool|null $is_conference is_conference
     *
     * @return self
     */
    public function setIsConference($is_conference)
    {
        if (is_null($is_conference)) {
            throw new \InvalidArgumentException('non-nullable is_conference cannot be null');
        }
        $this->container['is_conference'] = $is_conference;
    ...
    /**
     * Gets proof_image_link
     *
     * @return string|null
     */
    public function getProofImageLink()
    {
        return $this->container['proof_image_link'];
    }

    /**
     * Sets proof_image_link
     *
     * @param string|null $proof_image_link proof_image_link
     *
     * @return self
     */
    public function setProofImageLink($proof_image_link)
    {
        if (is_null($proof_image_link)) {
            array_push($this->openAPINullablesSetToNull, 'proof_image_link');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('proof_image_link', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['proof_image_link'] = $proof_image_link;
