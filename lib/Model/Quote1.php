 ...
 */
class Quote1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'quote_1';
    ...
    protected static $openAPIFormats = [
        'reported_volume_24h' => null,
        'adjusted_volume_24h' => null,
        'reported_volume_7d' => null,
        'adjusted_volume_7d' => null,
        'reported_volume_30d' => null,
        'adjusted_volume_30d' => null
    ];
    ...
    protected static array $openAPINullables = [
        'reported_volume_24h' => false,
        'adjusted_volume_24h' => false,
        'reported_volume_7d' => false,
        'adjusted_volume_7d' => false,
        'reported_volume_30d' => false,
        'adjusted_volume_30d' => false
    ];
    ...
    protected static $attributeMap = [
        'reported_volume_24h' => 'reported_volume_24h',
        'adjusted_volume_24h' => 'adjusted_volume_24h',
        'reported_volume_7d' => 'reported_volume_7d',
        'adjusted_volume_7d' => 'adjusted_volume_7d',
        'reported_volume_30d' => 'reported_volume_30d',
        'adjusted_volume_30d' => 'adjusted_volume_30d'
    ];
    ...
    protected static $setters = [
        'reported_volume_24h' => 'setReportedVolume24h',
        'adjusted_volume_24h' => 'setAdjustedVolume24h',
        'reported_volume_7d' => 'setReportedVolume7d',
        'adjusted_volume_7d' => 'setAdjustedVolume7d',
        'reported_volume_30d' => 'setReportedVolume30d',
        'adjusted_volume_30d' => 'setAdjustedVolume30d'
    ];
    ...
    protected static $getters = [
        'reported_volume_24h' => 'getReportedVolume24h',
        'adjusted_volume_24h' => 'getAdjustedVolume24h',
        'reported_volume_7d' => 'getReportedVolume7d',
        'adjusted_volume_7d' => 'getAdjustedVolume7d',
        'reported_volume_30d' => 'getReportedVolume30d',
        'adjusted_volume_30d' => 'getAdjustedVolume30d'
    ];
    ...
    {
        $this->setIfExists('reported_volume_24h', $data ?? [], null);
        $this->setIfExists('adjusted_volume_24h', $data ?? [], null);
        $this->setIfExists('reported_volume_7d', $data ?? [], null);
        $this->setIfExists('adjusted_volume_7d', $data ?? [], null);
        $this->setIfExists('reported_volume_30d', $data ?? [], null);
        $this->setIfExists('adjusted_volume_30d', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets reported_volume_24h
     *
     * @return float|null
     */
    public function getReportedVolume24h()
    {
        return $this->container['reported_volume_24h'];
    }

    /**
     * Sets reported_volume_24h
     *
     * @param float|null $reported_volume_24h reported_volume_24h
     *
     * @return self
     */
    public function setReportedVolume24h($reported_volume_24h)
    {
        if (is_null($reported_volume_24h)) {
            throw new \InvalidArgumentException('non-nullable reported_volume_24h cannot be null');
        }
        $this->container['reported_volume_24h'] = $reported_volume_24h;

        return $this;
    }

    /**
     * Gets adjusted_volume_24h
     *
     * @return float|null
     */
    public function getAdjustedVolume24h()
    {
        return $this->container['adjusted_volume_24h'];
    }

    /**
     * Sets adjusted_volume_24h
     *
     * @param float|null $adjusted_volume_24h adjusted_volume_24h
     *
     * @return self
     */
    public function setAdjustedVolume24h($adjusted_volume_24h)
    {
        if (is_null($adjusted_volume_24h)) {
            throw new \InvalidArgumentException('non-nullable adjusted_volume_24h cannot be null');
        }
        $this->container['adjusted_volume_24h'] = $adjusted_volume_24h;

        return $this;
    }

    /**
     * Gets reported_volume_7d
     *
     * @return float|null
     */
    public function getReportedVolume7d()
    {
        return $this->container['reported_volume_7d'];
    }

    /**
     * Sets reported_volume_7d
     *
     * @param float|null $reported_volume_7d 7d reported volume. This value is updated once per day at midnight (UTC). For example, at 2019-04-11 11:00 AM this value is the exchange volume between 2019-04-04 00:00:00 UTC and 2019-04-11 00:00:00 UTC
     *
     * @return self
     */
    public function setReportedVolume7d($reported_volume_7d)
    {
        if (is_null($reported_volume_7d)) {
            throw new \InvalidArgumentException('non-nullable reported_volume_7d cannot be null');
        }
        $this->container['reported_volume_7d'] = $reported_volume_7d;

        return $this;
    }

    /**
     * Gets adjusted_volume_7d
     *
     * @return float|null
     */
    public function getAdjustedVolume7d()
    {
        return $this->container['adjusted_volume_7d'];
    }

    /**
     * Sets adjusted_volume_7d
     *
     * @param float|null $adjusted_volume_7d 7d adjusted volume updated once per day at midnight (UTC). See `reported_volume_7d` description for more details
     *
     * @return self
     */
    public function setAdjustedVolume7d($adjusted_volume_7d)
    {
        if (is_null($adjusted_volume_7d)) {
            throw new \InvalidArgumentException('non-nullable adjusted_volume_7d cannot be null');
        }
        $this->container['adjusted_volume_7d'] = $adjusted_volume_7d;

        return $this;
    }

    /**
     * Gets reported_volume_30d
     *
     * @return float|null
     */
    public function getReportedVolume30d()
    {
        return $this->container['reported_volume_30d'];
    }

    /**
     * Sets reported_volume_30d
     *
     * @param float|null $reported_volume_30d 30d reported volume. This value is updated once per day at midnight (UTC). For example, at 2019-04-11 11:00 AM this value is the exchange volume between 2019-03-12 00:00:00 UTC and 2019-04-11 00:00:00 UTC
     *
     * @return self
     */
    public function setReportedVolume30d($reported_volume_30d)
    {
        if (is_null($reported_volume_30d)) {
            throw new \InvalidArgumentException('non-nullable reported_volume_30d cannot be null');
        }
        $this->container['reported_volume_30d'] = $reported_volume_30d;

        return $this;
    }

    /**
     * Gets adjusted_volume_30d
     *
     * @return float|null
     */
    public function getAdjustedVolume30d()
    {
        return $this->container['adjusted_volume_30d'];
    }

    /**
     * Sets adjusted_volume_30d
     *
     * @param float|null $adjusted_volume_30d 30d adjusted volume updated once per day at midnight (UTC). See `reported_volume_30d` description for more details
     *
     * @return self
     */
    public function setAdjustedVolume30d($adjusted_volume_30d)
    {
        if (is_null($adjusted_volume_30d)) {
            throw new \InvalidArgumentException('non-nullable adjusted_volume_30d cannot be null');
        }
        $this->container['adjusted_volume_30d'] = $adjusted_volume_30d;
