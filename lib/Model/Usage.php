...
class Usage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'message' => 'string',
        'current_month' => '\Randomsymbols\Coinpaprika\Model\CurrentMonth'
    ];
    ...
    */
     ...
     * Sets message
     *
     * @param string|null $message `limited plan` if the number of requests is limited in the current plan or `unlimited plan` if there is no limit on the number of requests
     *
     * @return self
     */
     ...
     * Gets current_month
     *
     * @return \Randomsymbols\Coinpaprika\Model\CurrentMonth|null
     */
     ...
     * Sets current_month
     *
     * @param \Randomsymbols\Coinpaprika\Model\CurrentMonth|null $current_month current_month
     *
     * @return self
     */
