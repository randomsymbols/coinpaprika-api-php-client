 ...
 */
class Tick implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tick';
    ...
    protected static $openAPITypes = [
        ...
        'last_updated' => 'string',
        'quotes' => 'array<string,\Randomsymbols\Coinpaprika\Model\Quote>'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('beta_value', $data ?? [], null);
    ...
    */
     ...
     *
     * @param float|null $circulating_supply circulating_supply
     *
     * @return self
     */
     ...
     * Sets total_supply
     *
     * @param float|null $total_supply total_supply
     *
     * @return self
     */
     ...
     * @return float|null
     */
    public function getBetaValue()
    {
        return $this->container['beta_value'];
    }

    /**
     * Sets beta_value
     *
     * @param float|null $beta_value beta_value
     *
     * @return self
     */
    public function setBetaValue($beta_value)
    {
        if (is_null($beta_value)) {
            throw new \InvalidArgumentException('non-nullable beta_value cannot be null');
        }
        $this->container['beta_value'] = $beta_value;
     ...
     * Sets first_data_at
     *
     * @param string|null $first_data_at first_data_at
     *
     * @return self
     */
     ...
     * Gets quotes
     *
     * @return array<string,\Randomsymbols\Coinpaprika\Model\Quote>|null
     */
     ...
     * Sets quotes
     *
     * @param array<string,\Randomsymbols\Coinpaprika\Model\Quote>|null $quotes quotes
     *
     * @return self
     */
