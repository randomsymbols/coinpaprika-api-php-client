 ...
 */
class IdChangelog implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'id_changelog';
    ...
    */
     ...
     * Sets old_id
     *
     * @param string|null $old_id old_id
     *
     * @return self
     */
     ...
     * Sets changed_at
     *
     * @param string|null $changed_at RFC3999 (ISO-8601) format
     *
     * @return self
     */
