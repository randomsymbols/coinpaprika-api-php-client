...
/**
 * HistoricalTick Class Doc Comment
 *
 * @category Class
 ...
 */
class HistoricalTick implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'historical_tick';
    ...
    */
     ...
     * Sets timestamp
     *
     * @param string|null $timestamp RFC3999 (ISO-8601) format
     *
     * @return self
     */
     ...
     * Sets volume_24h
     *
     * @param int|null $volume_24h volume_24h
     *
     * @return self
     */
