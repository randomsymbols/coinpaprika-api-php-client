...
class Contract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets contract
     *
     * @param string $contract The contract identifier, which is usually its address
     *
     * @return self
     */
     ...
     * Sets platform
     *
     * @param string $platform ID of the contract platform. For Ethereum contracts it is `eth-ethereum`, for Tron `trx-tron`, etc.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type Type of the contract. Currently supported values are: `ERC20`, `BEP2`, `TRC10`, `TRC20`, `Stellar Asset`, `Other`
     *
     * @return self
     */
