 ...
 */
class CoinsOhlcv implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'coins_ohlcv';
    ...
    */
     ...
     * Sets time_open
     *
     * @param string|null $time_open RFC3999 (ISO-8601) format
     *
     * @return self
     */
     ...
     * Sets time_close
     *
     * @param string|null $time_close RFC3999 (ISO-8601) format
     *
     * @return self
     */
     ...
     * Sets market_cap
     *
     * @param int|null $market_cap market_cap
     *
     * @return self
     */
    public function setMarketCap($market_cap)
    {
        if (is_null($market_cap)) {
            array_push($this->openAPINullablesSetToNull, 'market_cap');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('market_cap', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
