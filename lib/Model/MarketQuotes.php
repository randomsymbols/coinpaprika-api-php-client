...
/**
 * MarketQuotes Class Doc Comment
 *
 * @category Class
 * @package  Randomsymbols\Coinpaprika
 * @author   OpenAPI Generator team
 ...
 */
class MarketQuotes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'market_quotes';
    ...
    protected static $openAPITypes = [
        'key' => '\Randomsymbols\Coinpaprika\Model\MarketQuote'
    ];
    ...
    */
     ...
     * Gets key
     *
     * @return \Randomsymbols\Coinpaprika\Model\MarketQuote|null
     */
     ...
     * Sets key
     *
     * @param \Randomsymbols\Coinpaprika\Model\MarketQuote|null $key key
     *
     * @return self
     */
