...
/**
 * ExchangeWithShare Class Doc Comment
 *
 * @category Class
 * @package  Randomsymbols\Coinpaprika
 * @author   OpenAPI Generator team
 ...
 */
class ExchangeWithShare implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'exchange_with_share';
    ...
    protected static $openAPIFormats = [
        ...
        'name' => null,
        'fiats' => null,
        'adjusted_volume_24h_share' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'name' => false,
        'fiats' => false,
        'adjusted_volume_24h_share' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'name' => 'name',
        'fiats' => 'fiats',
        'adjusted_volume_24h_share' => 'adjusted_volume_24h_share'
    ];
    ...
    protected static $setters = [
        ...
        'name' => 'setName',
        'fiats' => 'setFiats',
        'adjusted_volume_24h_share' => 'setAdjustedVolume24hShare'
    ];
    ...
    protected static $getters = [
        ...
        'name' => 'getName',
        'fiats' => 'getFiats',
        'adjusted_volume_24h_share' => 'getAdjustedVolume24hShare'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('adjusted_volume_24h_share', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets adjusted_volume_24h_share
     *
     * @return float|null
     */
    public function getAdjustedVolume24hShare()
    {
        return $this->container['adjusted_volume_24h_share'];
    }

    /**
     * Sets adjusted_volume_24h_share
     *
     * @param float|null $adjusted_volume_24h_share adjusted_volume_24h_share
     *
     * @return self
     */
    public function setAdjustedVolume24hShare($adjusted_volume_24h_share)
    {
        if (is_null($adjusted_volume_24h_share)) {
            throw new \InvalidArgumentException('non-nullable adjusted_volume_24h_share cannot be null');
        }
        $this->container['adjusted_volume_24h_share'] = $adjusted_volume_24h_share;
