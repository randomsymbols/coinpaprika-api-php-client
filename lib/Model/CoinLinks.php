 ...
 */
class CoinLinks implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'coin_links';
    ...
    */
     ...
     * Sets explorer
     *
     * @param string[]|null $explorer List of links to blockchain explorers, if any
     *
     * @return self
     */
    ...
    {
        if (is_null($explorer)) {
            array_push($this->openAPINullablesSetToNull, 'explorer');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('explorer', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets facebook
     *
     * @param string[]|null $facebook List of links to Facebook pages of the cryptocurrency, if any
     *
     * @return self
     */
     ...
     * Sets reddit
     *
     * @param string[]|null $reddit List of links to Reddit communities and profiles, if any
     *
     * @return self
     */
     ...
     * Sets source_code
     *
     * @param string[]|null $source_code List of links to source code repositories, if any
     *
     * @return self
     */
     ...
     * Sets website
     *
     * @param string[]|null $website List of the cryptocurrency websites, if any
     *
     * @return self
     */
     ...
     * Sets youtube
     *
     * @param string[]|null $youtube List of links to Youtube channels of the cryptocurrency, if any
     *
     * @return self
     */
    ...
    {
        if (is_null($youtube)) {
            array_push($this->openAPINullablesSetToNull, 'youtube');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('youtube', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets medium
     *
     * @param string[]|null $medium List of links to Medium profiles of the cryptocurrency, if any
     *
     * @return self
     */
