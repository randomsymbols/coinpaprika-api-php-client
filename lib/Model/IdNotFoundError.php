...
/**
 * IdNotFoundError Class Doc Comment
 *
 * @category Class
 * @package  Randomsymbols\Coinpaprika
 * @author   OpenAPI Generator team
 ...
 */
class IdNotFoundError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'idNotFoundError';
    ...
    */
     ...
     * Sets error
     *
     * @param string|null $error ID not found error message
     *
     * @return self
     */
