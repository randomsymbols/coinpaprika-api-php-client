...
/**
 * CoinAndPosition Class Doc Comment
 *
 * @category Class
 * @package  Randomsymbols\Coinpaprika
 * @author   OpenAPI Generator team
 ...
 */
class CoinAndPosition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'coin_and_position';
    ...
    */
     ...
     * Sets coin_id
     *
     * @param string|null $coin_id coin_id
     *
     * @return self
     */
