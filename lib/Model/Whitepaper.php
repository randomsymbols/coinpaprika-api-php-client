 ...
 */
class Whitepaper implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'whitepaper';
    ...
    */
     ...
     * Sets link
     *
     * @param string|null $link The whitepaper URL
     *
     * @return self
     */
     ...
     * Sets thumbnail
     *
     * @param string|null $thumbnail Link to the whitepaper thumbnail
     *
     * @return self
     */
