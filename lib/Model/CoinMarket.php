 ...
 */
class CoinMarket implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'coin_market';
    ...
    */
     ...
     * Sets exchange_name
     *
     * @param string|null $exchange_name exchange_name
     *
     * @return self
     */
    public function setExchangeName($exchange_name)
    {
        if (is_null($exchange_name)) {
            throw new \InvalidArgumentException('non-nullable exchange_name cannot be null');
        }
