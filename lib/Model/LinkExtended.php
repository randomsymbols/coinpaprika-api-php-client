...
/**
 * LinkExtended Class Doc Comment
 *
 * @category Class
 * @package  Randomsymbols\Coinpaprika
 * @author   OpenAPI Generator team
 ...
 */
class LinkExtended implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'link_extended';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type Type of the link: `website`, `reddit`, `source_code`, etc.
     *
     * @return self
     */
     ...
     * Sets stats
     *
     * @param array<string,float>|null $stats An object containing the link stats like `subscribers` (for reddit), `followers` (for twitter), `members` (for telegram), `stars`, `contributors` (for source code)
     *
     * @return self
     */
