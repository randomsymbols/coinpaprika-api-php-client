...
class Info implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'plan_status' => 'string',
        'portal_url' => 'string',
        'usage' => '\Randomsymbols\Coinpaprika\Model\Usage'
    ];
    ...
    protected static $setters = [
        'plan' => 'setPlan',
        'plan_started_at' => 'setPlanStartedAt',
    ...
    protected static $getters = [
        'plan' => 'getPlan',
        'plan_started_at' => 'getPlanStartedAt',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('plan_started_at', $data ?? [], null);
    ...
    */
     ...
     * Sets plan
     *
     * @param string|null $plan Name of the API plan
     *
     * @return self
     */
    ...
    /**
     * Gets plan_started_at
     *
     * @return string|null
     */
    public function getPlanStartedAt()
    {
        return $this->container['plan_started_at'];
    }

    /**
     * Sets plan_started_at
     *
     * @param string|null $plan_started_at A date when the plan started in RFC3999 (ISO-8601) format
     *
     * @return self
     */
    public function setPlanStartedAt($plan_started_at)
    {
        if (is_null($plan_started_at)) {
            throw new \InvalidArgumentException('non-nullable plan_started_at cannot be null');
        }
        $this->container['plan_started_at'] = $plan_started_at;
     ...
     * Sets plan_status
     *
     * @param string|null $plan_status Status of the plan. There are 3 possible statuses: `active` - the subscription is active; `past_due` - the subscription payment failed. If payment is not made within 7 days, then the subscription will expire; `inactive` - the subscription is inactive.
     *
     * @return self
     */
     ...
     * Sets portal_url
     *
     * @param string|null $portal_url API Customer Portal URL
     *
     * @return self
     */
     ...
     * Gets usage
     *
     * @return \Randomsymbols\Coinpaprika\Model\Usage|null
     */
     ...
     * Sets usage
     *
     * @param \Randomsymbols\Coinpaprika\Model\Usage|null $usage usage
     *
     * @return self
     */
